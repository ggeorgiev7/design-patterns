...
public class TheWorkerForCountry extends Worker{
private String name;
	...
	public TheWorkerForCountry(String name) {
		super(name);
		this.destination = Worker.Country;
	}
	...
	protected void writeMessage(String message) {
		System.out.println("The Country worker " + message);
