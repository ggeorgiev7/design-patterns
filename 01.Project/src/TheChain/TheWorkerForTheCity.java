...
public class TheWorkerForTheCity extends Worker {
private String name;
	...
	public TheWorkerForTheCity(String name) {
		super(name);
		this.destination = Worker.City;
	}
	...
	protected void writeMessage(String message) {
		System.out.println("The worker for City " + message);
	}
}
